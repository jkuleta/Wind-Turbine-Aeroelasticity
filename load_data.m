function [StructuralParameters, OperationalParameters, AeroParameters] = load_data()
  ...
  %% Load key parameters - AERODYNAMICS
    ...
    xi = AeroParameters.blade_position_aero;

    AeroParameters.phi_1flap_aero = 0.0622  * xi.^2 + ...
        1.7254  * xi.^3 - ...
        3.2452  * xi.^4 + ...
        4.7131  * xi.^5 - ...
        2.2555  * xi.^6;
      ...
      AeroParameters.dphi_1flap_aero = (1 / StructuralParameters.R) * ( ...
              ...
              5 * 4.7131   * xi.^4 - ...
              6 * 2.2555   * xi.^5 );
      AeroParameters.ddphi_1flap_aero = (1 / StructuralParameters.R^2) * ( ...
              2 * 0.0622   + ...
              6 * 1.7254   * xi - ...
            12 * 3.2452   * xi.^2 + ...
            20 * 4.7131   * xi.^3 - ...
    ...
    AeroParameters.phi_1edge_aero = ...
      ...
      AeroParameters.ddphi_1edge_aero = (1 / StructuralParameters.R^2) * ( ...
              2 * 0.3627   + ...
              6 * 2.5337   * xi - ...
            12 * 3.5772   * xi.^2 + ...
            20 * 2.376    * xi.^3 - ...
